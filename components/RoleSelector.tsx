  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-text-primary mt-4 tracking-wide">Welcome to AI-Enhanced Academic Evaluation Suite</h1>
        <p className="text-text-secondary mt-2 max-w-md mx-auto">The future of intelligent assessment. Please select your role to continue.</p>
      </div>
